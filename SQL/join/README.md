...
Также в наших данных есть такой столбец order_status, где сказано утвержден / завершен заказ (Approved) или отменен (Cancel). Но у нас отсутствуют вводные на этот счет (а в последующих заданиях присутствуют),  учитывать order_status мы не будем.
