...
## Часть 2. 
В условии идет речь именно об одном SQL-запросе (у меня это файл *part 2.sql*), который выполнит все пункты, так и сделаем в конце. На всякий случай я добавил решение каждого пункта по отдельности в папку *part 2 items*, ведь итоговый запрос, по сути, просто объединяет данные решения. 
