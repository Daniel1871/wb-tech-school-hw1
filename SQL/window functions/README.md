...
Раз мы делаем задание по теме оконных функций, я в этом задании их и использую (первый запрос). Но данное задание несложно выполнить с помощью группировки, поэтому я решил с их помощью проверить результат своего первого запроса.
